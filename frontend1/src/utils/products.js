export const productDataList = [
  ...
  {
    productName: 'Men Printed Round Neck Cotton Blend White Shirt',
    price: {
      mrp: 1499,
      cost: 1166,
      discountPercent: 26,
    ...
    subcategory: 'Shirts',
    productImage: 'https://thefoomer.in/cdn/shop/files/MiConv.com__jpeg-optimizer_214_26_11zon.webp?v=1707386573&width=960',
    category: 'Cotton Shirts',
    description: 'go for this mens bright white satin cotton shirt with deer golden embroidery  partywear design that takes you from boardroom to ballroom without any hassle. Featuring a spread collar, and full sleeves this  go for party and casual.',
    tagline: 'Deal of the Day',
    quantity: 1,
    seller: "652ebf61b409f906d81645a3",
  },
